...
namespace DTS.Winfrm.res.code
{
    public class SQLiteHelper
    {
        ...
        public static string ConnectionString
        {
            get
            {
                return System.Configuration.ConfigurationSettings.AppSettings["sqlite"].ToString();
                ////(AppSettings节点下的"SQLiteConnectionString")
                //string text = System.Configuration.ConfigurationSettings.AppSettings["sqlite"].ToString();
